      ...
      <Tabs defaultValue="overview" className="mb-12">
        ...
        <TabsContent value="vision" className="space-y-6">
          <div className="prose max-w-none">
            ...
            <h2 className="text-2xl font-bold mt-8">Core Values</h2>
        ...
        <TabsContent value="leadership" className="space-y-6">
          <div className="grid gap-8 md:grid-cols-2">
            <Card>
              <CardHeader>
                <CardTitle>National Executive Board (NEB)</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>National Executive Council (NEC)</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2">
                  <li>
            ...
            <Card className="md:col-span-2">
              <CardHeader>
                <CardTitle>Branch Chairs</CardTitle>
              </CardHeader>
              <CardContent>
                ...
                <div className="mt-6">
                  <h4 className="font-semibold">Additional Members</h4>
        ...
        <TabsContent value="structure" className="space-y-6">
          <div className="prose max-w-none">
            ...
            <ul className="grid gap-2 sm:grid-cols-2 md:grid-cols-3 mt-4">
        ...
        <TabsContent value="committees" className="space-y-6">
          <div className="grid gap-8 md:grid-cols-3">
            <Card>
              <CardHeader>
                <CardTitle>KNAPO Ethics Committee</CardTitle>
              </CardHeader>
              <CardContent>
                <p>
            ...
            <Card>
              <CardHeader>
                <CardTitle>National Training Committee</CardTitle>
              </CardHeader>
              <CardContent>
                <p>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Investments Committee</CardTitle>
              </CardHeader>
              <CardContent>
                <p>
