              ...
              <CardContent className="p-0">
                <div className="p-4 md:p-6 border-b">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="p-3 bg-muted/40 rounded-lg">
                    <img src="/images/ViceNationalSecretary2.jpg" alt="Stephen Muthoka" className="w-full h-48 object-cover rounded mb-2"/>
                      <div className="font-medium">Vice National Secretary</div>
                      <div className="text-primary">Stephen Muthoka</div>
                    </div>
                    <div className="p-3 bg-muted/40 rounded-lg">
                    <img src="/images/NationalTreasurer2.jpg" alt="Edward Ochieng" className="w-full h-48 object-cover rounded mb-2"/>
